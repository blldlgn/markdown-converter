      ...
      <div className="mc-root">
        <div className="mc-inner">
          ...
          <div className="mc-footer">
            <div className="mc-footer-text">Claude subscription kullanir · API ucreti yok · Made by <strong><a href="https://bilaldalgun.com" target="_blank" style={{ color: "var(--ink)", textDecoration: "underline" }}>Bilal Dalgün</a></strong></div>
            <span className="mc-footer-tag">v5</span>
          </div>
